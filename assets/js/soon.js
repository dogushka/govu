...
let countDownDate = new Date('december 5 2021 14:00').getTime();
...
function counting(){
    ...
    // display the result
    days.innerHTML = remainingDays + 'д'
    hours.innerHTML = remaingHours + 'ч'
    minutes.innerHTML = remainingMinutes + 'м'
    seconds.innerHTML = remainingSeconds + 'с'
    ...
    if(different <= 0){
        ...
        counterHeading.innerHTML = 'ОБНОВЛЯЙТЕ САЙТ В ТЕЧЕНИЕ 5 МИНУТ!'
    }
}